...
class Game: Fragment() {
    ...
    override fun onStart() {
        ...
        mFirebaseAnalytics?.logEvent("livescore_game", null)
    ...
    private fun setupRecylerview() {
        ...
        val url = "https://apifootball.com/api/?action=get_events&from=$strToday&to=$strToday&APIkey="+ settingsMap["API_KEY"]
        ...
        client.newCall(request).enqueue(object: Callback {
            ...
            override fun onResponse(call: Call?, response: Response?) {
                ...
                liveFeed.matchs.forEach {
                    if (favouriteMap[it.match_id] != null) {
    ...
    private fun showEmptyMessage() {
        textView_message.text = "Henüz hiçbir maç seçmediniz."
        textView_message2.text = "Maçlarınızı seçmek için maçların yanındaki yıldız simgesine tıklayınız."
